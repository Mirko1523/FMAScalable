        ...
        <section className="relative flex items-center justify-center h-screen bg-gradient-to-r from-blue-600 to-blue-400 text-white">
          <div className="text-center px-6 md:px-12 lg:px-24">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-xl mx-auto">
              Escalamos tu negocio <strong>llevándolo a lo digital</strong>. Aumentamos tu imagen de marca estructurando tu <strong>Página Web</strong> y <strong>Plan de Marketing</strong> personalizado. <br></br> ¿Listo para escalar sin límites?
            </p>
